...
```{r simstudy1_2}
# 3.2.2 Vary degree of non-normality

# it says "or" -- is it supposed to be "and", i.e. check all of these things?
# coding it would be super simple once the structure above^^ is formalized
